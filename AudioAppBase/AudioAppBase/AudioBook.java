...
public class AudioBook extends AudioContent
{
	...
	{
		// Make use of the constructor in the super class AudioContent. -> DONE
  ...
  // Print information about the audiobook. First print the basic information of the AudioContent 
	...
	// see the video
	public void printInfo() // Using super.printInfo() for printing audioContent information, then printing audiobook information (author, narrator)
	{
		super.printInfo();
  ...
  // Play the audiobook by setting the audioFile to the current chapter title (from chapterTitles array list) 
	...
	public void play() // Setting audiofile to the Chapters title followed by current chapter, then super.play() to play the audiocontent
	{	
	...
	// See the video
	public void printTOC() // for loop to iterate through chapter titles, then pritning each chapter title.
	{
	...
	public boolean equals(Object other) // Casting other object into an audiobook, then using super.equals() to compare audiocontent information, and then check if author and narrator are equal.
	{
